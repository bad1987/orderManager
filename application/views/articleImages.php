<?php include("templates/adminHeader.php"); ?>
    ...
    <div class="inline-menu">
      <ul>
		...
		<h3 class="text-center"> Gestion des images des articles</h3>
    <div class="row justify-content-center">
          ...
          <div class="card">
              ...
              <div class="card-body">
              	...
              	<form action="<?php echo site_url('setartimage') ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
    ...
    <?php if($this->session->flashdata('success') !== null){
      echo  '<h5 class="text-success" style="text-align: center;">'.$this->session->flashdata('success').'</h5>';
