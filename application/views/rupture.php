	...
	<div class="row justify-content-center">
		<div class="col-md-5">
	      <div class="card">
	          ...
	          <div class="card-body">
	          	<!-- <?php echo form_open("interruption",['class' => 'form-horizontal']) ?> -->
	          	<form action="<?php echo site_url('validateinterrupt') ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
