...
<div class="container-fluid">
	<h3 style="text-align: center;margin-top: 2em;">Gestion des articles</h3>
	<hr>
		...
		<div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                	...
                	<form action="updateArticles" class="form-horizontal" method="post" enctype="multipart/form-data">
